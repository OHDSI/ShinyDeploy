...
sidebarMenu <-
  shinydashboard::sidebarMenu(
    ...
    if (exists("validationMetrics"))
      addInfo(
        shinydashboard::menuItem(text = "Validation Metrics", tabName = "validationMetrics"),
        infoId = "validationMetricsInfo"
      ),
    
    if (exists("diagnosticModel"))
      addInfo(
        shinydashboard::menuItem(text = "Diagnostic Model", tabName = "diagnosticModel"),
        infoId = "diagnosticModelInfo"
      ),
...
bodyTabItems <- shinydashboard::tabItems(
  ...
  shinydashboard::tabItem(tabName = "validationMetrics",
                          DT::dataTableOutput("validationMetricsTable")),
  
  shinydashboard::tabItem(tabName = "diagnosticModel",
                          DT::dataTableOutput("diagnosticModelTable")),
