...
validationFiles <- list.files(dataFolder, full.names = TRUE, pattern = "validation_results")
...
diagnosticModelFiles <- list.files(dataFolder, full.names = TRUE, pattern = "diagnostic_model")
