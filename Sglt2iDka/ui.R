          ...
          ")),
                  ...
                  tabsetPanel(id = "mainTabsetPanel",
                              tabPanel("About",
                                       ...
                                       HTML("<ul>"),									   
									   HTML("<li>The full manuscript is available at: <a href=\"https://onlinelibrary.wiley.com/doi/full/10.1002/pds.4887\">https://onlinelibrary.wiley.com/doi/full/10.1002/pds.4887</a><br/></li>" ),									   
                                       ...
                                       HTML("<li>The full study protocol and statistical analysis plan is available at: <a href=\"https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iDka/documents\">https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iDka/documents</a><br/></li>"),
                                       HTML("<li>The full source code for the study is available at: <a href=\"https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iDka/programs\">https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iDka/programs</a></li>"),
                                       HTML("</ul>")
                              ),
