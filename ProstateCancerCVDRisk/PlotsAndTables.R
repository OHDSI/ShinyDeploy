...
# MC Note: I was trying to trouble shoot why the code below seems to be suppressing output for all PS plots but could not figure out it out.
#          Rather than spend more time with it, I decided to comment it out and move forward.
#  if (length(ps$targetDensity) < 2 | length(ps$comparatorDensity < 2)) {
#    return(NULL)
#  }
