...
join @target_database_schema.cp_master cp on cp.concept_id = c.concept_id
...
join @target_database_schema.cp_master cp2 on cp2.concept_id = c2.concept_id
left join @target_database_schema.recommended_blacklist rb on c2.concept_id = rb.concept_id
