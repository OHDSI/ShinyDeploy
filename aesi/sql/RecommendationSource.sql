...
from list l
join @results_database_schema.recommender_set r on l.concept_id = r.source_id
join @vocabulary_database_schema.concept c on c.concept_id = r.concept_id and c.standard_concept is null
join @results_database_schema.cp_master cp on cp.concept_id = c.concept_id
...
join @results_database_schema.cp_master cp2 on cp2.concept_id = c2.concept_id
left join @results_database_schema.recommended_blacklist rb on c2.concept_id = rb.concept_id
