...
setCookie = function(params) {
  Cookies.set("Covid19CharacterizationCharybdisDiagFeature", escape(params), { expires: 30 });
}
...
Shiny.addCustomMessageHandler("rmCookie", function(params) {
  Cookies.remove("Covid19CharacterizationCharybdisDiagFeature");
  setInputValue(params);
});
...
$(document).on('shiny:sessioninitialized', function(event) {
  var cookie = Cookies.get("Covid19CharacterizationCharybdisDiagFeature");
