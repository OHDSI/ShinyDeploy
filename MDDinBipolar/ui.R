...
ui <- shinydashboard::dashboardPage(skin = 'black',
                                    ...
                                    shinydashboard::dashboardHeader(title = "MDD Bipolar", 
                                    ...
                                    shinydashboard::dashboardSidebar(
                                      shinydashboard::sidebarMenu(id ='menu',
                                                                  ...
                                                                  addInfo(shinydashboard::menuItem("TimeAUC", tabName = "TimeAUC", icon = shiny::icon("clock")), "timeAucInfo"),
                                                                  addInfo(shinydashboard::menuItem("Survival", tabName = "Survival", icon = shiny::icon("line-chart")), "survivalInfo"),
                                        ...
                                        shinydashboard::tabItem(tabName = "Performance", 
                                                                ...
                                                                shiny::fluidRow(
                                                                  ...
                                                                  tabBox(
                                                                    ...
                                                                    tabPanel("Spline Plot", 
                                                                             shiny::fluidRow(
                                                                               shinydashboard::box(status = 'info',
                                                                                                   title = "Spline Plot", solidHeader = TRUE, width = 12,
                                                                                                   shinycssloaders::withSpinner(shiny::plotOutput('spline')))
                                                                             )
                                                                    )
                                                                                             ))),
