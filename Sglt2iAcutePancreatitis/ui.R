...
shinyUI(fluidPage(style = 'width:1500px;',
                  ...
                  tabsetPanel(id = "mainTabsetPanel",
                              tabPanel("About",
                                       ...
                                       HTML("<li>The full study protocol and statistical analysis plan is available at: <a href=\"https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iAcutePancreatitis/documents\">https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iAcutePancreatitis/documents</a><br/></li>"),
                                       HTML("<li>The full source code for the study is available at: <a href=\"https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iAcutePancreatitis\">https://github.com/OHDSI/StudyProtocols/tree/master/Sglt2iAcutePancreatitis</a></li>"),
                                       HTML("</ul>")
                              ),
