...
shinyServer(function(input, output, session) {
  ...
  getCohortInfoTable <- reactive({
    ...
    githubCohortUrl <- "https://github.com/ohdsi-studies/ScyllaCharacterization/tree/master/inst/sql/sql_server/"
  ...
  getCohortCountsTablePivotedByDB <- reactive({
    columnsToInclude <- c("cohortId","targetId","targetName","subgroupId","subgroupName","cohortType", "cohortSubjects")
