loadDataFromDB <- function(connPool, networkSchema = "charybdis_stage") {
...
getCovariateValue <- function(connPool, networkSchema = "charybdis_stage", cohortId, databaseList, comparatorCohortId = NULL) {
