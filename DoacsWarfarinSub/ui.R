  ...
  fluidPage(style = "width:1500px;",
            ...
            tabsetPanel(id = "mainTabsetPanel",
                        tabPanel("About",
                                 ...
                                 HTML("<p>Antithrombotic therapies are associated with increased bleeding risk. Abnormal uterine bleeding has been reported in clinical trials evaluating direct oral anticoagulants (DOACs) in patients with venous thromboembolism (VTE), but data are limited in those with atrial fibrillation (AF). Using real-world data from 4 US healthcare databases, we compared the occurrence of severe uterine bleeding among women newly exposed to rivaroxaban, apixaban, dabigatran, and warfarin stratified by indication. To reduce potential confounding, patients in comparative cohorts were matched on propensity scores (PS). Overall incidence of severe uterine bleeding was low in the populations exposed to DOACs, although relatively higher in the younger VTE population (AF: 1.9-10.1 events/1,000 person-years; VTE: 2.9-34.2 events/1,000 person-years). In the PS-matched AF population, a suggestive, moderately increased risk of severe uterine bleeding was observed for rivaroxaban relative to warfarin (hazard ratios [HRs] and 95% confidence intervals ranging from 0.83 [0.27-2.48] to 2.84 [1.32-6.23] across databases due to heterogeneity for this comparison), apixaban (pooled HR using meta-analysis: 1.45 [0.91-2.28]), and dabigatran (2.12 [1.01-4.43]), which were sensitive to time-at-risk period. In the PS-matched VTE population, a consistent, increased risk of severe uterine bleeding was observed for rivaroxaban relative to warfarin (2.03 [1.19-3.27]) and apixaban (2.25 [1.45-3.41]), which were insensitive to time-at-risk period. There was no strong evidence suggesting differential severe uterine bleeding risk between apixaban, dabigatran, and warfarin in either population. For women who need antithrombotic therapy, personalized management strategies with careful evaluation of benefits and risks are required.</p>"),
