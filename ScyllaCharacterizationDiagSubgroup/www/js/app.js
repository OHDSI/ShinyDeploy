...
setCookie = function(params) {
  Cookies.set("ScyllaCharacterizationDiagSubgroup", escape(params), { expires: 30 });
}
...
Shiny.addCustomMessageHandler("rmCookie", function(params) {
  Cookies.remove("ScyllaCharacterizationDiagSubgroup");
  setInputValue(params);
});
...
$(document).on('shiny:sessioninitialized', function(event) {
  var cookie = Cookies.get("ScyllaCharacterizationDiagSubgroup");
