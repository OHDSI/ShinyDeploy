...
shinyUI(
  fluidPage(style = "width:1500px;",
            titlePanel(paste("Safety of hydroxychloroquine, alone or in combination with azithromycin, in light of rapid wide-spread use for COVID-19: a multinational, network cohort and self-controlled case series study", if(blind) "***Blinded***" else "")),
            ...
            tabsetPanel(id = "mainTabsetPanel",
                        tabPanel("About",
                                 ...
                                 HTML("<p><strong>Results:</strong> Overall, 950,769 and 306,706 users of hydroxychloroquine and sulfasalazine, and 318,821 and 337,424 users of hydroxychloroquine-azithromycin and hydroxychloroquine-amoxicillin were included. No excess risk of SAEs was identified when 30-day hydroxychloroquine and sulfasalazine use were compared. SCCS confirmed these findings. However, when azithromycin was added to hydroxychloroquine, we observed an increased risk of 30-day cardiovascular mortality (CalHR 2.19 (95% CI 1.22-3.94)), chest pain/angina, and heart failure.</p>"),
